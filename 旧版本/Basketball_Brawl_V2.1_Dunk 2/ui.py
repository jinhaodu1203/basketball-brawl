...
def main_menu(screen, font, small_font, title_font):
    """正式主菜单。返回 play / settings / quit。"""
    options = [("PLAY", "play"), ("SETTINGS", "settings"), ("QUIT", "quit")]
    selected = 0
    ...
    while True:
        ...
        pygame.draw.circle(screen, (60, 75, 120), (SCREEN_WIDTH // 2, 118), 82)
        pygame.draw.circle(screen, (255, 170, 55), (SCREEN_WIDTH // 2, 118), 54)
        pygame.draw.line(screen, (40, 35, 30), (SCREEN_WIDTH // 2 - 54, 118), (SCREEN_WIDTH // 2 + 54, 118), 4)
        pygame.draw.arc(screen, (40, 35, 30), (SCREEN_WIDTH // 2 - 54, 64, 108, 108), 1.0, 2.15, 4)
        pygame.draw.arc(screen, (40, 35, 30), (SCREEN_WIDTH // 2 - 54, 64, 108, 108), 4.15, 5.28, 4)
        ...
        for index, (label, _) in enumerate(options):
            rect = pygame.Rect(SCREEN_WIDTH // 2 - 145, 290 + index * 62, 290, 48)
