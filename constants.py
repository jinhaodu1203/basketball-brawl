...
# ---------- V2.0 运球系统 ----------
DRIBBLE_SPEED_IDLE = 0.16
DRIBBLE_SPEED_MOVING = 0.24
DRIBBLE_HAND_OFFSET_X = 25
DRIBBLE_HAND_OFFSET_Y = 27
DRIBBLE_GROUND_CLEARANCE = 4
DRIBBLE_MOVING_SWAY = 5

# ---------- V2.0.2 盖帽系统 ----------
BLOCK_REACH_X = 34
BLOCK_REACH_Y = 30
BLOCK_COOLDOWN_FRAMES = 18
BLOCK_HORIZONTAL_FORCE = 7.5
BLOCK_VERTICAL_FORCE = -5.5
AI_BLOCK_HORIZONTAL_RANGE = 72
AI_BLOCK_VERTICAL_RANGE = 135

# ---------- V2.1 扣篮系统 ----------
DUNK_TRIGGER_DISTANCE = 112
DUNK_TRIGGER_VERTICAL = 112
DUNK_MIN_UPWARD_SPEED = -1.0
DUNK_COOLDOWN_FRAMES = 45
DUNK_POINTS = 2
AI_DUNK_APPROACH_DISTANCE = 145
AI_DUNK_TAKEOFF_DISTANCE = 105
SCREEN_SHAKE_DUNK = 10
HIT_STOP_DUNK_FRAMES = 5
DUNK_TEXT_FRAMES = 62

# ---------- V3.6 上篮系统 ----------
LAYUP_TRIGGER_DISTANCE = 125
LAYUP_FLIGHT_FRAMES = 26
LAYUP_HORIZONTAL_ERROR = 10
LAYUP_POINTS = 2
...
ANIMATION_SPEED = 8
DEFAULT_FRAME_COUNTS = {"idle": 1, "run": 1, "jump": 1}
BALL_SPRITE_FRAME_COUNT = 3
BALL_STATE_TO_FRAME = {"held": 0, "flying": 1, "passing": 1, "loose": 2}


# ---------- 传球系统 ----------
PASS_MIN_FRAMES = 9
PASS_MAX_FRAMES = 22
PASS_PIXELS_PER_FRAME = 18
PASS_CATCH_RADIUS = 44
PASS_INTERCEPT_RADIUS = 48
PASS_RECEIVE_IMMUNITY_FRAMES = 18

POINTS_OUTSIDE_THREE = 3
POINTS_ON_OR_INSIDE_THREE = 2
WINNING_SCORE = 21

SCORE_POPUP_DURATION_FRAMES = 90
ROUND_RESET_DELAY_FRAMES = 105
...
AI_REBOUND_JUMP_RANGE = 92

# ---------- 篮板系统 ----------
REBOUND_REACH_X = 42
REBOUND_REACH_Y = 54
REBOUND_CATCH_RADIUS = 34
REBOUND_COOLDOWN_FRAMES = 18
REBOUND_POSSESSION_IMMUNITY = 36
BOX_OUT_RANGE = 58
BOX_OUT_PRIORITY_BONUS = 16
...
SCREEN_SHAKE_BLOCK = 7
HIT_STOP_BLOCK_FRAMES = 3
SCREEN_SHAKE_REBOUND = 2
HIT_STOP_REBOUND_FRAMES = 1
